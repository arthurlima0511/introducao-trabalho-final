...
export default function JurosSimples() {
  ...
  return (
    <>
      <div className="flex justify-around items-center min-h-[80vh] gap-16">
        <form
          onSubmit={(e) => {
            e.preventDefault();
            handleCalcular();
        ...
        >
          ...
          <div className="flex flex-col gap-6 justify-start items-start mt-[5rem]">
            {valorTotal === "0" ? (
